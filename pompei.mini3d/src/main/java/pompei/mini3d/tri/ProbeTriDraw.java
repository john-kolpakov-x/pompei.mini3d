...
/**
 * Draws tri
 * <p>Autogenerated by class pompei.mini3d.generator.GenTri</p>
 * <p>At 2015-02-07T00:10:02.928+0600</p>
 */
public final class ProbeTriDraw {
  ...
  public ProbeTriDraw(PointBuffer pointBuffer) {
  ...
  private final void drawTra(  double xA , double xB , double yA1, double yB1, double yA2, double yB2, double zA1, double zB1, double zA2, double zB2) {
    ...
    if (yB1 > yB2 || yA1 > yA2) {
      ...
      tmp=yB1; yB1=yB2; yB2=tmp;
      tmp=zB1; zB1=zB2; zB2=tmp;
      tmp=yA1; yA1=yA2; yA2=tmp;
      tmp=zA1; zA1=zA2; zA2=tmp;
    }
    ...
    double Co = ((x2-x1)*(x3-x1) + (y2-y1)*(y3-y1) + (z2-z1)*(z3-z1))/sqrt((x2-x1)*(x2-x1) + (y2-y1)*(y2-y1) + (z2-z1)*(z2-z1))/sqrt((x3-x1)*(x3-x1) + (y3-y1)*(y3-y1) + (z3-z1)*(z3-z1));
    double Si2 = 1-Co*Co;
    ...
    OUT: for (; xi < xB; xi += xStep) {
      ...
      IN: for (; yi < yEND; yi += yStep) {
        ...
        double A12 = ((xi-x1)*(x2-x1) + (yi-y1)*(y2-y1) + (zi-z1)*(z2-z1))/V12_2;
        double A13 = ((xi-x1)*(x3-x1) + (yi-y1)*(y3-y1) + (zi-z1)*(z3-z1))/V13_2;
  ...
  private int textureColor(double u, double v) {
    ...
    int r = (int)((r11 + (r12 - r11)*(U-U11)) + ((r21 + (r22 - r21)*(U-U11)) - (r11 + (r12 - r11)*(U-U11)))*(V-V11) + 0.5);
    int g = (int)((g11 + (g12 - g11)*(U-U11)) + ((g21 + (g22 - g21)*(U-U11)) - (g11 + (g12 - g11)*(U-U11)))*(V-V11) + 0.5);
    int b = (int)((b11 + (b12 - b11)*(U-U11)) + ((b21 + (b22 - b21)*(U-U11)) - (b11 + (b12 - b11)*(U-U11)))*(V-V11) + 0.5);
    
    return ((r & 0xFF) << (2 * 8)) | ((g & 0xFF) << (1 * 8)) | ((b & 0xFF) << (0 * 8)) | ((0xFF) << (3 * 8));
