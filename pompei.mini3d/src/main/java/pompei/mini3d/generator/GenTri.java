...
public class GenTri {
  ...
  public void run() throws Exception {
    File outFile = new File(src + "/pompei/mini3d/tri/TreeDraw.java");
  ...
  private void printAll() {
    ...
    out.println();
    out.println("public final class TreeDraw {");
    out.println("");
    ...
    out.println("  ");
    out.println("  public TreeDraw(PointBuffer pointBuffer) {");
    ...
    out.println("    ");
    out.println("    drawTra(x1, x2, y1, y2, y1, y4, z1, z2, z1, z4);");
    out.println("    drawTra(x2, x3, y2, y3, y4, y3, z2, z3, z4, z3);");
    out.println("    ");
    out.println("  }");
    out.println("");
    out.println("  private final static double DEEP_SIZE = 2 * (double)Integer.MAX_VALUE - 1;");
    out.println("  ");
    out.println("  private final void drawTra(double xA, double xB, double yA1, double yB1, double yA2, double yB2, double zA1, double zB1, double zA2, double zB2) {");
    out.println("    ");
    out.println("    if (yB1 > yB2 || yA1 > yA2) {");
    out.println("      double tmp = yB1;yB1 = yB2;yB2 = tmp;");
    out.println("      ");
